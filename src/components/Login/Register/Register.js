...
const Register = () => {
    ...
    const handleLoginSubmit = e => {
        ...
        registerUser(loginData.email, loginData.password, loginData.name, loginData.type, loginData.age, loginData.phone, loginData.address, loginData.area, loginData.profilePicture, loginData.nidPicture, loginData.license, loginData.carInformation, loginData.category, loginData.status, history);
        e.preventDefault();
    }
